...
void fdc_dma_init() {
    ...
    IoWrite8(0x0A, 0x06);       // mask DMA channel 2 and 0 (assuming 0 is already masked) 0110=6

    // Запись адреса $001000
    ...
    IoWrite8(0x0A, 0x02);       // unmask DMA channel 2: 0010
}
